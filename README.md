...
A [Model Context Protocol](https://modelcontextprotocol.io) server designed by [Mateo LBS](https://github.com/MatLBS) to interact with the [42 API](https://api.intra.42.fr). It lets AI assistants look up 42 students' profiles and progression, and browse campus life — locations, events, and exams.

## Features

- **Profiles & progression:** Look up any 42 student's profile, cursus progression, project statuses, and earned achievements by login or ID
